...
public class DriverController {
	...
	@GetMapping("/carInfo")
	public List<DriverDTO> findDriverByCarProperties(@RequestParam Map<String, String> givenParams) {
		return driverService.findDriverByCarProperties(CarMapper.makeCarDTOFromMap(givenParams));
	}
