...
INSERT INTO CAR(ID, CONVERTIBLE, DATE_CREATED, ENGINE_TYPE, LICENSE_PLATE, RATING, SEAT_COUNT, MANUFACTURER, DELETED, DATE_UPDATED)
VALUES(1, true, now(),  'Gas', '1q2w3e', 15.0, 3, 1, false, now());

INSERT INTO CAR(ID, CONVERTIBLE, DATE_CREATED, ENGINE_TYPE, LICENSE_PLATE, RATING, SEAT_COUNT, MANUFACTURER, DELETED, DATE_UPDATED)
VALUES(2, true, now(),  'Electric', '1q2w3e', 15.0, 4, 1, false, now());

INSERT INTO CAR(ID, CONVERTIBLE, DATE_CREATED, ENGINE_TYPE, LICENSE_PLATE, RATING, SEAT_COUNT, MANUFACTURER, DELETED, DATE_UPDATED)
VALUES(3, false, now(),  'Gas', '1q2w3e', 15.0, 6, 1,false, now());